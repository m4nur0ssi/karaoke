...
const SONG_DATABASE = {
    ...
    'raphaly': [
        { artist: 'Ninho', title: 'La vie qu\'on mène', hints: ["Gazo", "Damso", "Tiakola", "SDM"] },
        { artist: 'PNL', title: 'Onizuka', hints: ["DTF", "Ademo", "N.O.S", "Ziak"] },
        { artist: 'Hamza', title: 'Lalla', hints: ["SCH", "Zola", "SDM", "Gazo"] },
        { artist: 'Dadju', title: 'Reine', hints: ["Gims", "Tayc", "Franglish", "Ninho"] },
        { artist: 'Zola', title: 'La guitare suit la mélo', hints: ["Gazo", "Koba LaD", "Maes", "Ninho"] },
        { artist: 'Aya Nakamura', title: 'Comportement', hints: ["Aya", "Gazo", "Damso", "Tiakola"] },
        { artist: 'Jul', title: 'J\'oublie tout', hints: ["Jul", "SCH", "Naps", "Alonzo"] },
        { artist: 'Orelsan', title: 'La Quête', hints: ["Vald", "Lomepal", "Nekfeu", "Damso"] },
        { artist: 'SDM', title: 'TI TI TI', hints: ["SDM", "Gazo", "Tiakola", "Ninho"] },
        { artist: 'Gazo', title: 'Casanova', hints: ["Central Cee", "Zola", "Koba LaD", "Gazo"] },
        { artist: 'Tiakola', title: 'Coucher de soleil', hints: ["Niska", "Hamza", "Gazo", "Tiakola"] },
        { artist: 'Naps', title: 'Ma ville et ma vie', hints: ["Jul", "Soso Maness", "L'Algérino", "Naps"] },
        { artist: 'SCH', title: 'Train Mistral', hints: ["Jul", "Naps", "Soso Maness", "SCH"] },
        { artist: 'PLK', title: 'Bleu & rouge', hints: ["Soso Maness", "Oboy", "Zola", "PLK"] },
        { artist: 'Tayc', title: 'Comme toi', hints: ["Dadju", "Burnaboy", "Wizkid", "Tayc"] }
    ],
    'grungerock': [
